...
const t2deviceTypes: Record<string, T2Factory> = {
    ...
    // F_VA front-load washer (protocol 4.8 / RTK_RTL8711am); same AABB 0x20 status layout as F_V__F
    ...
    ['RH10V9_CH']: RH10V9_CH, // LG heat-pump dryer — probe/monitor-enable until frames mapped
